    ...
    difference()
{
    union()
    {
        difference()
        {
            ...
            translate([ -d / 2, -s / 2, 1.5 ]) cube([ d, s, v ]);
...
translate([ 13, 26, 1 ]) // sloupky deska
    sloupek1();
translate([ -26, 26, 1 ]) sloupek1();
translate([ -26, -26, 1 ]) sloupek1();
translate([ 13, -26, 1 ]) sloupek1();
...
translate([ -20, 22.5, 1 ]) // sloupky display
    sloupek3();
translate([ 3.2, 22.5, 1 ]) sloupek3();
translate([ -20, -1, 1 ]) sloupek3();
translate([ 3.2, -1, 1 ]) sloupek3();

translate([ -21, 23, 1 ]) // opěrky display
    dist2();
translate([ 1.5, 23, 1 ]) dist2();
translate([ -21, -2.5, 1 ]) dist2();
translate([ 1.5, -2.5, 1 ]) dist2();
