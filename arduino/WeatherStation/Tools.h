...
//List of all strings
enum tStrings {
  s_Connecting_WiFi=0, s_Searching, s_or_wait_for_setup, s_Connecting_IoT_Center, s_Reset_wait, s_Detecting_location, s_Checking_update, s_Updating_time, s_Updating_weather, s_Calculate_moon_phase, s_Updating_forecasts, s_Connecting_InfluxDB, s_Saving_Status, s_Done,
